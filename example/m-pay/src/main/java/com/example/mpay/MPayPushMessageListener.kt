...
/**
 * Here MPay SDK can receiver callbacks of the push notifications of the Main App if App already integrated MoEngage SDK.
 * This usecase will not be valid except few cases. If MPay needs to send push directly to all the app users, Mpay needs to initialize
 * Firebase Secondary instance
 * */
class MPayPushMessageListener : PushMessageListener() {
