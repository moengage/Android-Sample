...
import com.moengage.sampleapp.ordertracking.STRIP_TRACKER_DOT_COLOR_HEX
...
/**
 * Renders the progress strip as a bitmap for the API 34–35
 * [androidx.core.app.NotificationCompat.BigPictureStyle] fallback.
 */
internal fun createProgressStripBitmap(payload: OrderTrackingPayload, trackerPosition: Int): Bitmap {
