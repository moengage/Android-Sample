...
import com.moengage.sampleapp.ordertracking.DEFAULT_STALE_CHIP_TEXT
import kotlinx.serialization.SerialName
import kotlinx.serialization.Serializable

/** One coloured section of the progress bar (length is relative, not pixels). */
@Serializable
internal data class OrderTrackingSegment(@SerialName("color") val color: String, @SerialName("size") val size: Int)
