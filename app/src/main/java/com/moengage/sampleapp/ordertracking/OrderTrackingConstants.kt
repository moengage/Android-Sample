/**
 * All shared constants for the order-tracking flow.
 * Kept in one file so channel IDs, SDK gates, and the tick interval are greppable in one place.
 */
...
internal const val ACTION_STOP_ORDER_TRACKING = "com.moengage.sampleapp.ordertracking.STOP"
...
/** Number of stages in the Brew Bar order journey — see [com.moengage.sampleapp.domain.model.OrderStage]. */
internal const val ORDER_STAGE_COUNT = 4
...
internal const val STRIP_TRACKER_DOT_COLOR_HEX = "#06333A"
