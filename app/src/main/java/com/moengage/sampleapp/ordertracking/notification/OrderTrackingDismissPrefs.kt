...
/** Persists user dismiss per order for [com.moengage.sampleapp.ordertracking.model.OrderTrackingPayload.respectUserDismiss]. */
internal object OrderTrackingDismissPrefs {

    private const val PREFS_NAME = "order_tracking_dismiss"

    fun isDismissed(context: Context, orderId: String): Boolean = prefs(context).getBoolean(dismissKey(orderId), false)
