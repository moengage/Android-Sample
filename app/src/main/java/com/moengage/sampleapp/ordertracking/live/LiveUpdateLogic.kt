...
import com.moengage.sampleapp.ordertracking.CHIP_MINUTE_ROUND_UP_MS
import com.moengage.sampleapp.ordertracking.MS_PER_MINUTE
import com.moengage.sampleapp.ordertracking.model.OrderTrackingPayload
import com.moengage.sampleapp.ordertracking.model.defaultTrackerEnd
...
internal data class LiveUpdateDisplayState(val chipText: String, val trackerPosition: Int, val stale: Boolean)
...
internal fun shouldScheduleLiveUpdate(payload: OrderTrackingPayload, stale: Boolean, receivedAtMs: Long): Boolean {
